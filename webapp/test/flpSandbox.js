		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo CI/CD Github",
									"targetURL": "#softtekdemocicdgithub-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"softtekdemocicdgithub-display": {
								"semanticObject": "softtekdemocicdgithub",
								"action": "display",
								"description": "Demo CI/CD Github",
								"title": "Demo CI/CD Github",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=softtek.democicdgithub",
									"url": sap.ui.require.toUrl("softtek/democicdgithub")
								}
							}
						}
					}
